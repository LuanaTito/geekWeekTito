  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        toolbarHeight: 100,
        centerTitle: true,
title: const Text('Descricao das atividades',style: TextStyle(fontSize:22,color: Colors.black,fontFamily: 'Sui Generis'),maxLines: 2,textAlign: TextAlign.center,),
       actions: <Widget>[
    ...
    child: ClipRRect(
      ...
      child: const Image(image: AssetImage('images/FIFA-jogo.jpg'), fit: BoxFit.cover),
        ...
        Text(
          ...
          style: TextStyle(fontWeight: FontWeight.bold, fontSize: 20, fontFamily: 'Segoe UI '),
        ),
