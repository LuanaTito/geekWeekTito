...
class BrinquedosOpticos extends StatelessWidget{
  const BrinquedosOpticos({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Brinquedos ópticos de animação', style: TextStyle(fontSize: 35),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
            ...
            Row(
              ...
              children: const[
                 Text('Data:', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),) ,
                   Text('22/08/23', style: TextStyle(fontSize: 20),) ,
            ],)
              ],
            )
          ),
        Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: const [
              ...
              Text('Entenda como o princípio dos desenhos animados amplamente difundidos na TV e nos meios digitais pode ser facilmente reproduzível analogicamente com materiais simples. Tenha a experiência concreta de perceber os movimentos acontecendo em tinta e papel e produza suas próprias animações.', style: TextStyle(fontSize: 22),), 
            ],
          )
