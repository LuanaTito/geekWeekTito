...
class DesenhoLivre extends StatelessWidget{
  const DesenhoLivre({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        toolbarHeight: 100,
        centerTitle: true,
title: const Text('Descrição das atividades',style: TextStyle(fontFamily: 'Sui Generis',fontSize:30,color: Colors.black,),maxLines: 2,textAlign: TextAlign.center,),
       actions: <Widget>[
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Desenho à mão livre: Simpsons, ETs e Monstros!', style: TextStyle(fontSize: 35),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
            ...
            Row(
              ...
              children: const[
                 Text('Data:', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),) ,
                   Text('21/08/23', style: TextStyle(fontSize: 20),) ,
            ],)
              ],
            )
          ),
        Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: const [
              ...
              Text('O uso das formas geométricas para construir, desenvolver e movimentar cenas dinâmicas usadas em Hqs, animações, filmes e games e como o model sheet e o guia de estilo são fundamentais para mantermos um padrão  entre vários artistas que irão desenhar personagens e cenários específicos.', style: TextStyle(fontSize: 18),), 
            ],
          )
