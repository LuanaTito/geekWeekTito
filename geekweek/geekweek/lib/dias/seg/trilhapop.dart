...
class TrilhaPop extends StatelessWidget{
  const TrilhaPop({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Apresentação de trilhas sonoras da cultura pop.', style: TextStyle(fontSize: 35),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
          ...
          SizedBox(
            child:  Row(
              ...
              children: const[
                 ...
                 Text('Atrio', style: TextStyle(fontSize: 20),) ,
       ...
       Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: const  [
              ...
              Text('Apresentação de trilhas sonoras da cultura pop.', style: TextStyle(fontSize: 22),), 
            ],
          )
