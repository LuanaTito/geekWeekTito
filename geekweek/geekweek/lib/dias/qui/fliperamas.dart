    ...
    children: const [
        ...
        Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: const [
              Text('Entre na máquina do tempo e volte à era dourada dos fliperamas, onde a diversão era medida em fichas e a competição era uma arte. Desafie seus amigos em jogos clássicos como Pac-Man, Street Fighter e Space Invaders, imergindo-se em gráficos pixelados e trilhas sonoras icônicas. ', style: TextStyle(fontSize: 22, fontFamily: 'Sui Generis'),),
