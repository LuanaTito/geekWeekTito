...
class DesafioMaker extends StatelessWidget{
  const DesafioMaker({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Desafio Maker: Automatizando um B1', style: TextStyle(fontSize: 35),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
          ...
          SizedBox(
            child:  Row(
              ...
              children: const[
                 ...
                 Text('Makers', style: TextStyle(fontSize: 20),) ,
        ...
        Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children:  const[
              ...
              Text('Nesta oficina que acontecerá na sala Makers do Senac Lapa Tito, os participantes serão desafiados a montar algo proposto pelo Clube da Mecatrônica Jovem. Será que conseguirão? Os momentos finais serão apresentados na live que acontece todas as quartas e quintas no Youtube e Twitch Tv.', style: TextStyle(fontSize: 22),), 
            ],
          )
