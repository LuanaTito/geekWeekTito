...
class ArtistsAlley extends StatelessWidget{
  const ArtistsAlley({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Artists Alley dos alunos', style: TextStyle(fontSize: 35),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
          ...
          SizedBox(
            child:  Row(
              ...
              children: const[
                 ...
                 Text('Corredor', style: TextStyle(fontSize: 20),) ,
            ...
            Row(
              ...
              children: const[
                 Text('Data:', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),) ,
                   Text('21-25/08/23', style: TextStyle(fontSize: 20),) ,
            ],)
              ],
            )
          ),
        Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: const [
              ...
              Text('Um espaço para que os artistas possam apresentar seus trabalhos, interagir com seu público de perto.', style: TextStyle(fontSize: 22),), 
            ],
          )
