...
class DescBody extends StatelessWidget{
  ...
  decoration: BoxDecoration(
    ...
    child: ClipRRect(
      borderRadius: BorderRadius.circular(15),
      child: const Image(image: AssetImage('images/monstro3D.jpg'), fit: BoxFit.cover),
  ),
)
),
    ...
    children: const [
        ...
        Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: const [
              Text('Explore um universo de possibilidades artísticas com a poderosa suíte da Adobe. Com o Substance, você tem o controle total sobre texturas, materiais e efeitos visuais. ', style: TextStyle(fontSize: 22, fontFamily: 'Sui Generis'),),
