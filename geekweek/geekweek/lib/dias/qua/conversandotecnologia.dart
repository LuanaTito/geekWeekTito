...
class ConversandoTecnologia extends StatelessWidget{
  const ConversandoTecnologia({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Conversando sobre Tecnologia', style: TextStyle(fontSize: 35),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
          ...
          SizedBox(
            child:  Row(
              ...
              children: const[
                 ...
                 Text('3S', style: TextStyle(fontSize: 20),) ,
            ...
            Row(
              ...
              children: const[
                 Text('Data:', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),) ,
                   Text('23/08/23', style: TextStyle(fontSize: 20),) ,
            ],)
              ],
            )
          ),
        Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children: const [
              ...
              Text('Nesta palestra o prof. Newton C. Braga fala o que podemos esperar do futuro da eletrônica e tecnologia, trazendo sua vivência como divulgador científico e Professor de Eletrônica.', style: TextStyle(fontSize: 22),), 
            ],
          )
