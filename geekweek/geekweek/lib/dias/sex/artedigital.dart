...
class ArteDigital extends StatelessWidget{
  const ArteDigital({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    return Scaffold(
      ...
      appBar:AppBar(
        ...
        toolbarHeight: 100,
        centerTitle: true,
title: const Text('Descrição das atividades',style: TextStyle(fontSize:27,color: Colors.black,fontFamily: 'Sui Generis'),maxLines: 2,textAlign: TextAlign.center,),
       actions: <Widget>[
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Arte Digital – Traço e Acabamento de Hq Infantil, Disney e Heróis', style: TextStyle(fontSize: 35, fontFamily: 'Sui Generis'),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
            ...
            Row(
              ...
              children: const[
                 Text('Data:', style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20),) ,
                   Text('25/08/23', style: TextStyle(fontSize: 20),) ,
            ],)
              ],
            )
          ),
      Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children:  const  [
              ...
              Text('Como é feita a arte digital de histórias em quadrinhos em diversos estilos de traço, desde o Infantil, Cartoon, Disney e Heróis.', style: TextStyle(fontSize: 20,fontFamily: 'Segoe UI'),), 
            ],
          )
