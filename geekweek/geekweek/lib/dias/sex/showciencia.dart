...
class ShowCiencia extends StatelessWidget{
  const ShowCiencia({Key?key}):super(key: key);
  ...
  Widget build(BuildContext context){
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          const Text('Show de Ciência', style: TextStyle(fontSize: 35),textAlign: TextAlign.center,),
          SizedBox(
            width: containerWidth,
       ...
       Column(
          mainAxisAlignment: MainAxisAlignment.spaceAround,
            children:  const [
              ...
              Text('Apresentação com experimentos interativos em uma montagem cheia de humor. As atividades articulam conceitos do cotidiano com ciência de maneira simples e prática.', style: TextStyle(fontSize: 22),), 
            ],
          )
